          ...
          <div className="w-[90%] max-w-[700px]">
            <form className="space-y-4">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full h-20 px-2 py-1 bg-[#e6e6e6] border-[1px] border-gray-400"
                  />
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <textarea
                    ...
                    className={`w-full h-20 px-2 py-1 border-[1px] border-gray-400 ${
              ...
              <div className="text-center mt-4 space-y-1">
                <p className="text-gray-700">you are registering as a Client</p>
                <p className="text-gray-700">
                  to register as a Notary instead - {' '}
                  <Link to="/register-notary" className="text-blue-600 hover:text-blue-800">
                    register as notary
                  </Link>
                </p>
              </div>
